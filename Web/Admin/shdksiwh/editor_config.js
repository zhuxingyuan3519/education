...
(function () {
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        , imageUrl: URL + "net/imageUp.ashx"             //图片上传确认地址
        ...
        //附件上传配置区
        , fileUrl: URL + "net/fileUp.ashx"               //附件上传确认地址
        , filePath: URL + "net/"                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件确认的表单名，若此处修改，需要在后台对应文件修改对应参数
        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        , catcherUrl: URL + "net/getRemoteImage.ashx"   //处理远程图片抓取的地址
        , catcherPath: URL + "net/"                  //图片修正地址，同imagePath
        //,catchFieldName:"upfile"                   //确认到后台远程图片uri合集，若此处修改，需要在后台对应文件修改对应参数
        //,separater:'ue_separate_ue'               //确认至后台的远程图片地址字符串分隔符
        ...
        //word转存配置区
        , wordImageUrl: URL + "net/imageUp.ashx"             //word转存确认地址
        ...
        //,textarea:'editorValue' // 确认表单时，服务器获取编辑器确认内容的所用的参数，多实例时可以给容器name属性，会将name给定的值最为每个实例的键值，不用每次实例化的时候都设置这个值
        ...
        //,allHtmlEnabled:false //确认到后台的数据是否包含整个html字符串
        //iframeUrlMap
