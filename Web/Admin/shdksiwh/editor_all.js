...
var domUtils = dom.domUtils = {
     ...
     * @example
     * //Before remove
     * <span style="font-size:8px;" id="test" name="followMe">xxxxx</span>
     * //Remove
     * UE.dom.domUtils.removeAttributes(node,["id","name"]);
     * //After remove
     * <span style="font-size:8px;">xxxxx</span>
     */
...
//                });
        ...
        /**
         * 同步编辑器的数据，为确认数据做准备，主要用于你是手动确认的情况
         * @name sync
