<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportWord.aspx.cs" Inherits="Web.Admin.TrainManage.ImportWord" %>
        ...
        function loadUploadify(iyt) {
            ...
            $('#file_upload').uploadifive({
                ...
                'onUploadComplete': function (file, data) {
                    ...
                    $("#div_fileContainer").html(appendHtml);
                },
...
<body>
            ...
            <form id="form1" style="padding: 30px">
                ...
                <div class="row">
                    <div class="col col-md-6">
                        <div class="form-group">
                            <label>
                                教材版本:<select id="ddl_Version" runat="server" require-type="require" require-msg="教材版本">
                                </select></label>
                        </div>
                    </div>
                    ...
                    <div class="col col-md-6">
                        <div class="form-group">
                            <label>
                                年级:<select id="ddl_Grade" runat="server" require-type="require" require-msg="年级">
                                </select>
                                <select id="ddl_Leavel" runat="server" require-type="require" require-msg="册别">
                                </select>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            <label>
                                修订范围:<select id="ddl_option" runat="server" require-type="require" require-msg="修订范围" onchange="showTip(this)">
                                    ...
                                    <option value="4">导入单词列表文件，生成新的匹配造句项目</option>
                                      <option value="5">导入已匹配文件，生成新的单词列表</option>
                                </select></label>
                            <label id="lb_tip" style="color: red">导入的Excel只能包含四列，列名分别为：【序号】【单词】【音标】【中文】</label>
                        </div>
                    </div>

                     <div class="col col-md-6" id="div_showIsCommon" >
                         <div class="form-group">
                            是否归属基础词库： <select id="ddl_isCommon" runat="server">
                ...
                <div class="row">
                    <div class="col col-md-12">
                        <div class="form-group">
                            <a href="javascript:void(0)" class="btn  gree a-addbtn" title="btnUpload" data-toggle="modal" data-target="#myModal" onclick="showUpload(this,1)">上传Excel文件</a>
                        </div>
                ...
                <div class="row">
                    <div class="col col-md-12 text-center">
                        <div class="form-group">
                               <input type="button" class="btn btn-primary hidden" value="批量导入导出" onclick="callhtml('TrainManage/BatchImportWord', '批量导入导出');" />&emsp;&emsp;
    ...
    <script type="text/javascript">
        function showTip(obj) {
            var thival = $(obj).val();
            if (thival == "1" || thival == "3") {
                $("#div_showIsCommon").show();
            }
            else {
                $("#div_showIsCommon").hide();
            }
            if (thival == "4") {
                $("#lb_tip").html("导入的Excel表只能两列，列名为【序号】【单词】【音标】【中文】");
            }
            else {
