        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(cid))
            {
                ...
                else if (type == "3")
                {
                    ...
                    obj.Name = cname;
                    obj.Code = string.IsNullOrEmpty(ccode) ? CommonHelper.GetNewCode : ccode;
                ...
                else if (type == "5")
                {
                    ...
                    result = CommonBase.Delete<CM_Dict>(obj).ToString();
                }
                else if (type == "6")
                {
                    //删除二级分类
                ...
                {
                    //删除子类
                    string sql = "delete from CM_Dict   where ParentCode='" + cid + "'";
                    CommonBase.RunSql(sql);
                }
            }
            //刷新缓存
