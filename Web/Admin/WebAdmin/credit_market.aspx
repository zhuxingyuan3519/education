<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="credit_market.aspx.cs" Inherits="Web.Admin.WebAdmin.credit_market" %>
            ...
            if (checkForm()) {
                $.ajax({
                    ...
                    success: function (info) {
                        ...
                        callhtml('WebAdmin/credit_market.aspx', '信贷超市管理');
                    }
                });
            }
        }
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="Code_<%# Container.ItemIndex + 1%>" value="<%#Eval("Code")%>" require-type="require"
                                        require-msg="信贷超市编码" class="normal_input tabInput" type="text" readonly="readonly" />
                                </td>
                                <td>
                                    <input name="Name_<%# Container.ItemIndex + 1%>" value="<%#Eval("Name")%>" require-type="require"
                                        require-msg="信贷名称" class="normal_input tabInput" type="text" />
                                </td>
                                       <td class="">
