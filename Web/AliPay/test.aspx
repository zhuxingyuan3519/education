<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="Web.AliPay.test" %>
	...
	<div id="main">
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dt>商品展示网址：</dt>
                    <dd>
                        <asp:TextBox ID="WIDshow_url" name="WIDshow_url" runat="server" Text="http://192.168.0.102:8095/posmarket"></asp:TextBox>
                    </dd>
                    <hr class="one_line">
                    <dt>商品描述：</dt>
                    <dd>
                        <asp:TextBox ID="WIDbody" name="WIDbody" runat="server" Text="测试商品"></asp:TextBox>
                    </dd>
                    <hr class="one_line">
                    <dt></dt>
                    <dd id="btn-dd">
