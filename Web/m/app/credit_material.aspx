<%@ Page Title="" Language="C#" MasterPageFile="~/m/app/kgjSite.Master" AutoEventWireup="true" CodeBehind="credit_material.aspx.cs" Inherits="Web.m.app.credit_material" %>
    ...
    <script src="/common/laytpl/laytpl.js"></script>
     <script type="text/javascript">
         ...
         function getPageList(curr) {
             ...
             //ajax获取
             $.getJSON("/Handler/GetMateralsPageList.ashx", param, function (res) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="row personer text-center">
         <img src="../images/bookpicker.png"  class="img-responsive imgshowtitle" />
        <h4 id="h4_bankName" runat="server"></h4>
    </div>
    <div class="row">
        <ul class="list-group" id="appendView"></ul>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooterHolder" runat="server">
     ...
     {{# for (var i = 0; i<d.length; i++){ }}
            <li class="list-group-item"><a href="credit_materialcontent?id={{ d[i].ID}}"><img src="/images/right_arrow.png"  />{{ d[i].NTitle }}</a></li>
        {{# } }}
     </script>
