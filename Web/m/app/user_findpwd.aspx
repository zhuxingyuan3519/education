<%@ Page Title="" Language="C#" MasterPageFile="~/m/app/mSiteV1.Master" AutoEventWireup="true" CodeBehind="user_findpwd.aspx.cs" Inherits="Web.m.app.user_findpwd" %>
      ...
      <div class="row list-card">
                ...
                <div class="marg">
                    <div class="col-sm-12 col-xs-12 marg">
                        <a class="btn btn-block gree" href="javascript:void(0)" onclick="setupChange()">确认修改</a>
                    </div>
                </div>
            </div>
</asp:Content>
