<%@ Page Title="" Language="C#" MasterPageFile="~/m/app/mSiteV1.Master" AutoEventWireup="true" CodeBehind="no_rank_detail.aspx.cs" Inherits="Web.m.app.no_rank_detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
             ...
             function getPageList(curr) {
                 var pagesi = 10;
                 //分页参数，需要传到后台的
                 var param = { type: 'norank', pageIndex: curr, pageSize: pagesi };
                 //ajax获取
