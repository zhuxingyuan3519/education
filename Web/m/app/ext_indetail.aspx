<%@ Page Title="" Language="C#" MasterPageFile="~/m/app/mSiteV1.Master" AutoEventWireup="true" CodeBehind="ext_indetail.aspx.cs" Inherits="Web.m.app.ext_indetail" %>
<%--我的推荐列表--%>
...
<div class="row">
    ...
    <div class="col-sm-4 col-xs-4  padding-left-right-0">
        <select id="ddl_type" class="form-control" >
            <option value="">-奖励项目-</option>
            <option value="16">推荐VIP</option>
            <option value="17">推荐分销商</option>
            <option value="95">推荐服务中心</option>
              <option value="189">推荐城市合伙人</option>
               <option value="999">增购名额</option>
              <%-- <option value="RankLeavel">增购名额</option>--%>
        </select>
    </div>
                ...
                <div class="clickButton">
				    <div class="col-sm-12 col-xs-12 div_in_list">
				       <span class="col-sm-6 col-xs-6 text-left">日期：{{d[i].CutTime }}</span>
                        <span class="col-sm-6 col-xs-6 text-left">金额： ￥{{ d[i].FHMoney }}</span>
                          <span class="col-sm-12 col-xs-12 text-left">奖励项目：{{ d[i].FHType }}</span>
				    </div>
                </div>
			</div>
        {{# } }}
